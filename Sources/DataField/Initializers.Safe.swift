...
extension DataField where Data: LosslessStringConvertible {
    ...
    /// Creates a data field that emits valid data values into a given sink for
    /// `LosslessStringConvertible` data.
    /// This is a convenience initializer over
    /// `init(_:initialData:textToData:dataToText:editableText:sink:invalidText)`.
    ///
    /// - Parameters:
    ///
    ///   - title: The title of the text view, describing its purpose.
